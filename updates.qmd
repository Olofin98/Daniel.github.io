...
::: {.column width="50%"}
![Averitt Award: Excellence in Research](RR.jpeg){fig-align="center" width="100%"}
:::

::: {.column width="50%"}
![Averitt Award: Excellence in Research](RRRRRR.jpeg){fig-align="center" width="100%"}
:::
...
::: {.column width="50%"}
![Master's Thesis Defense](CP_2.jpeg){fig-align="center" width="100%"}
:::

::: {.column width="50%"}
![Master's Thesis Defense](RRRRRRR.jpg){fig-align="center" width="100%"}
:::

::::

Successfully defended my thesis titled *“Computational Maximum Likelihood Estimation for Nonlinear Compartmental ODE Epidemic Models with Correlated Time Series Errors.”*

The work developed a computational framework integrating epidemic dynamics with time-series modeling to improve infectious disease inference and prediction.
Why this works
